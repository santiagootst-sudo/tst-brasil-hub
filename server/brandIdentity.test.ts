...
const brandSource = readFileSync(
  resolve(process.cwd(), "client/src/components/BrandLockup.tsx"),
  "utf8"
);
...
const workspaceSource = readFileSync(
  resolve(process.cwd(), "client/src/pages/WorkspaceHub.tsx"),
  "utf8"
);
...
describe("identidade TST Brasil Hub", () => {
  ...
  it("publica metadados coerentes com a marca atual", () => {
    ...
    expect(htmlSource).toContain('href="/assets/tst-favicon.png"');
    expect(publicAssetsSource).toContain('hero: "/assets/tst-hero.jpg"');
    expect(publicAssetsSource).not.toContain("manuscdn.com");
