...
export const createEmployeeInput = workspaceIdInput.extend({
  ...
  cpf: z.string().trim().min(11).max(24).nullable().optional(),
...
export const trainingSchema = z.object({
  ...
  participants: z.array(z.object({ employeeId: z.number().int().positive(), fullName: z.string(), cpf: z.string().nullable(), roleName: z.string().nullable(), companyId: z.number().int().positive() })).default([]),
  createdByUserId: z.number().int().positive(),
  createdAt: z.date(),
  updatedAt: z.date(),
});
