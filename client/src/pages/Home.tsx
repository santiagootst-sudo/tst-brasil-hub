...
const launchPlans = [
  { code: "Mensal", price: "R$ 69,90", period: "/mês", billing: "Oferta de entrada. Depois, R$ 99,90/mês.", advantage: "Comece com flexibilidade", label: "Para experimentar", tone: "border-[#d8e9e4]", featured: false },
  { code: "Trimestral", price: "R$ 89,90", period: "/mês", billing: "Cobrança de R$ 269,70 a cada 3 meses.", advantage: "Economize R$ 120 no ano versus o mensal", label: "Planejamento de 90 dias", tone: "border-[#d8e9e4]", featured: false },
  { code: "Anual", price: "R$ 74,90", period: "/mês", billing: "Cobrança única de R$ 898,80 por ano.", advantage: "Economize R$ 300 no ano versus o mensal", label: "Melhor custo mensal", tone: "border-[#0c8c89] ring-4 ring-[#d9f1e7]", featured: true },
] as const;
...
export default function Home() {
  ...
  const selectPlanOnWhatsApp = (plan: typeof launchPlans[number]) => {
    const text = `Olá! Quero solicitar acesso ao TST Brasil Hub no plano ${plan.code}. Condição: ${plan.billing} Meu nome é: `;
