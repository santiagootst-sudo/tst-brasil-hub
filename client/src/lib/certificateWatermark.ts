...
export const certificateWatermarkThemes: Record<CertificateNr, CertificateWatermarkTheme> = {
  "NR-05": {
    ...
    color: "#8c6f3d",
    assetUrl: inlineWatermarkUrl("certificate-watermark-nr05_c09495dd.jpg"),
    kind: "cipa",
  },
  "NR-10": {
    nr: "NR-10",
    ...
    color: "#0c8c89",
    assetUrl: inlineWatermarkUrl("certificate-watermark-nr10_b040e9df.jpg"),
    kind: "electricity",
  },
  "NR-15": {
    nr: "NR-15",
    ...
    color: "#2b9a70",
    assetUrl: inlineWatermarkUrl("certificate-watermark-nr15_552a2d54.jpg"),
    kind: "noise",
  },
  "NR-20": {
    nr: "NR-20",
    ...
    color: "#d78343",
    assetUrl: inlineWatermarkUrl("certificate-watermark-nr20_db15a211.jpg"),
    kind: "fire",
  },
  "NR-33": {
    nr: "NR-33",
    ...
    color: "#c85e55",
    assetUrl: inlineWatermarkUrl("certificate-watermark-nr33_6aa5caf5.jpg"),
    kind: "confined",
  },
  "NR-35": {
    nr: "NR-35",
    ...
    color: "#3b72a4",
    assetUrl: inlineWatermarkUrl("certificate-watermark-nr35_3d8a561b.jpg"),
    kind: "height",
  },
};
